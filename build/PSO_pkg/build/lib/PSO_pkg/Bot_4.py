...
class Bot4Node(Node):
    ...
    def __init__(self):
        super().__init__('bot_4')
        
        self.publisher_ = self.create_publisher(Point, 'bot_4_point', 10)
        self.publisher_twist = self.create_publisher(Twist, 'bot_4_twist', 10)
        ...
        self.subs_point_4 = self.create_subscription(
            Point, f'bot_4_point_update', self.point_callback, 10)
        self.subs_twist_4 = self.create_subscription(
            Twist, f'bot_4_twist_update', self.twist_callback, 10)
