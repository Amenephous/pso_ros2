...
class Bot1Node(Node):
    ...
    def __init__(self):
        super().__init__('bot_1')
        
        self.publisher_ = self.create_publisher(Point, 'bot_1_point', 10)
        self.publisher_twist = self.create_publisher(Twist, 'bot_1_twist', 10)
        ...
        self.subs_point_1 = self.create_subscription(
            Point, f'bot_1_point_update', self.point_callback, 10)
        self.subs_twist_1 = self.create_subscription(
            Twist, f'bot_1_twist_update', self.twist_callback, 10)
